...
export type AuthHeadersFragment = {
  __typename: "Headers";
  accessToken: string;
  uid: string;
  client: string;
...
export type MatchFragment = {
  ...
  id: string;
  round: number;
  field: { __typename?: "Field"; id: string; maxSeats?: number | null };
  matchResult?: { __typename?: "Result"; description?: string | null } | null;
  referee?: {
    __typename?: "Referee";
    id: string;
    firstName: string;
  ...
  viewers: Array<{ __typename?: "Player"; id: string }>;
};
...
export type TournamentFragment = {
  ...
  startDate: any;
  court: { __typename?: "Court"; name?: string | null };
  organizer: {
    __typename?: "Organizer";
    id: string;
    firstName: string;
...
export type BookMatchMutation = {
  __typename?: "Mutation";
  bookMatch?: { __typename?: "Player"; id: string } | null;
};
...
export type CreateMatchResultMutation = {
  __typename?: "Mutation";
  createMatchResult?: { __typename?: "Referee"; id: string } | null;
};
...
export type CreateTournamentMutation = {
  __typename?: "Mutation";
  createTournament?: { __typename?: "Organizer"; id: string } | null;
};
...
export type JoinTournamentMutation = {
  __typename?: "Mutation";
  joinTournament?: { __typename?: "Player"; id: string } | null;
};
...
export type SignOutMutation = {
  __typename?: "Mutation";
  signOut?: { __typename?: "ActionResult"; result: ActionResultEnum } | null;
};
...
export type UnbookMatchMutation = {
  __typename?: "Mutation";
  unbookMatch?: { __typename?: "Player"; id: string } | null;
};

export type CourtsAllQueryVariables = Exact<{ [key: string]: never }>;

export type CourtsAllQuery = {
  __typename?: "Query";
  courtsAll: Array<{ __typename?: "Court"; id: string; name?: string | null }>;
};
...
export type JoinableTeamsQuery = {
  __typename?: "Query";
  me:
    | { __typename?: "Organizer" }
    | {
...
export type JoinedTournamentsQueryVariables = Exact<{ [key: string]: never }>;

export type JoinedTournamentsQuery = {
  __typename?: "Query";
  me:
    | { __typename?: "Organizer" }
    | {
        __typename?: "Player";
        id: string;
        joinedTournaments: Array<{ __typename?: "Tournament"; id: string }>;
      }
    | { __typename?: "Referee" };
};
...
export type MeQuery = {
  ...
  me:
    ...
    | {
        ...
        lostMatches: Array<{ __typename?: "Result"; id: string }>;
        wonMatches: Array<{ __typename?: "Result"; id: string }>;
      }
    | {
        __typename: "Referee";
        id: string;
...
export type RefereedTournamentsQuery = {
  __typename?: "Query";
  me:
    | { __typename?: "Organizer" }
    | { __typename?: "Player" }
...
export type TournamentsAllQuery = {
  __typename?: "Query";
  tournamentsAll: Array<{
    __typename: "Tournament";
    id: string;
    name?: string | null;
    composition: CompositionEnum;
...
export function useBookMatchMutation() {
  return Urql.useMutation<BookMatchMutation, BookMatchMutationVariables>(
    BookMatchDocument,
  );
}
...
export function useUnbookMatchMutation() {
  return Urql.useMutation<UnbookMatchMutation, UnbookMatchMutationVariables>(
    UnbookMatchDocument,
  );
}
...
export function useCourtsAllQuery(
  options?: Omit<Urql.UseQueryArgs<CourtsAllQueryVariables>, "query">,
) {
  return Urql.useQuery<CourtsAllQuery, CourtsAllQueryVariables>({
    query: CourtsAllDocument,
    ...options,
  });
}
...
export function useJoinableTeamsQuery(
  options: Omit<Urql.UseQueryArgs<JoinableTeamsQueryVariables>, "query">,
) {
  return Urql.useQuery<JoinableTeamsQuery, JoinableTeamsQueryVariables>({
    query: JoinableTeamsDocument,
    ...options,
  });
}
export const JoinedTournamentsDocument = gql`
...
export function useJoinedTournamentsQuery(
  options?: Omit<Urql.UseQueryArgs<JoinedTournamentsQueryVariables>, "query">,
) {
  return Urql.useQuery<JoinedTournamentsQuery, JoinedTournamentsQueryVariables>(
    { query: JoinedTournamentsDocument, ...options },
  );
}
...
export function useMatchQuery(
  options: Omit<Urql.UseQueryArgs<MatchQueryVariables>, "query">,
) {
  return Urql.useQuery<MatchQuery, MatchQueryVariables>({
    query: MatchDocument,
    ...options,
  });
}
...
export function useRefereedTournamentsQuery(
  options?: Omit<Urql.UseQueryArgs<RefereedTournamentsQueryVariables>, "query">,
) {
  return Urql.useQuery<
    RefereedTournamentsQuery,
    RefereedTournamentsQueryVariables
  >({ query: RefereedTournamentsDocument, ...options });
}
...
export function useRefereesAllQuery(
  options?: Omit<Urql.UseQueryArgs<RefereesAllQueryVariables>, "query">,
) {
  return Urql.useQuery<RefereesAllQuery, RefereesAllQueryVariables>({
    query: RefereesAllDocument,
    ...options,
  });
}
...
export function useSportsQuery(
  options?: Omit<Urql.UseQueryArgs<SportsQueryVariables>, "query">,
) {
  return Urql.useQuery<SportsQuery, SportsQueryVariables>({
    query: SportsDocument,
    ...options,
  });
}
...
export function useTournamentQuery(
  options: Omit<Urql.UseQueryArgs<TournamentQueryVariables>, "query">,
) {
  return Urql.useQuery<TournamentQuery, TournamentQueryVariables>({
    query: TournamentDocument,
    ...options,
  });
}
...
export function useTournamentsAllQuery(
  options?: Omit<Urql.UseQueryArgs<TournamentsAllQueryVariables>, "query">,
) {
  return Urql.useQuery<TournamentsAllQuery, TournamentsAllQueryVariables>({
    query: TournamentsAllDocument,
    ...options,
  });
}
